...
<ComparisonTable
  ...
  rows={[
    ...
    ['Diffusion', 'Starts from noise, progressively adds information until patterns emerge', '<strong>Image generation</strong> (also audio/text)'],
    ...
    ['VAE', 'Neural network + probabilistic modeling', '<strong>Anomaly detection in time-series data</strong>'],
  ]}
/>
