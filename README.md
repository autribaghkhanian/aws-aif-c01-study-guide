...
- **8 pages**: exam overview, one page per domain (weighted 20/24/28/14/14%), a consolidated AWS service index, and high-yield facts
...
- **Flashcard mode**: the high-yield facts double as tap-to-flip quiz cards
...
- `src/data/high-yield.json` — the high-yield facts + flashcard prompts
