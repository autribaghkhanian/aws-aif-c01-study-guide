...
- **8 pages**: exam overview, one page per domain (weighted 20/24/28/14/14%), a consolidated AWS service index, and 28 high-yield facts
...
- **Flashcard mode**: the 28 high-yield facts double as tap-to-flip quiz cards
...
- `src/data/high-yield.json` — the 28 facts + flashcard prompts
